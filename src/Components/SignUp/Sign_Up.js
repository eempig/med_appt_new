        ...
        <div className="signup-form">
         <form method="POST" onSubmit={register}>
           <div className="form-group">
            ...
            <div className="btn-group" style={{ display: 'flex', width: 'auto', alignItems: 'flex-start' }}>
                        <button type="submit" className="btn btn-primary mb-2 waves-effect waves-light" style={{ width: '15%', marginRight: '2%' }}>Submit</button>
                        <button type="reset" className="btn btn-danger mb-2 waves-effect waves-light" style={{ width: '15%' }}>Reset</button>
                    </div>
